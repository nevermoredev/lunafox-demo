...
<script type="text/javascript">var hellopreloader = document.getElementById("hellopreloader_preload");function fadeOutnojquery(el){el.style.opacity = 1;var interhellopreloader = setInterval(function(){el.style.opacity = el.style.opacity - 0.05;if (el.style.opacity <=0.05){ clearInterval(interhellopreloader);hellopreloader.style.display = "none";}},16);}window.onload = function(){setTimeout(function(){fadeOutnojquery(hellopreloader);},1000);};</script>
 	<div id="gradient">
        ...
        <buttom class="hide-menu"><img src="images/def/menu_mobile.png"></buttom>
 				<ul class="menu">
 					<li><a id="selected" href="/">Главная</a></li>
 		...
 		<div class="content">
 			<div class="stock_box">
        <p class="stock_preview">Скидка 30% только до 1 декабря всем парочкам!!</p>
        <div class="stock_img"><img src="/images/def/stock.jpg"></div>
        
 		</div>
    <div class="stock_box">
      <p class="stock_preview">Приминение новой коллекции на деле!</p>
        <div class="stock_vid"><iframe width="100%" height="auto" src="https://www.youtube.com/embed/mZ9W9VyBCuk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
    </div>
 		<footer>
 		</footer>
